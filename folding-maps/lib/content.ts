...
export const articles: Article[] = [
  ...
  {
    slug: 'open-weight-price-war', image: '/images/code-waterfall.svg', date: '12 Aug 2026', read: '19 min read', tag: 'AI market', title: 'Model prices have fallen; the cost of dependable automation has not', intro: 'Lower model costs widen the set of viable experiments. The strategic question is where cheaper intelligence can produce a dependable return.',
  ...
  {
    slug: 'automation-before-agents', image: '/images/case-property.svg', date: '28 Jul 2026', read: '19 min read', tag: 'Practical AI', title: 'Agents fail on the exceptions the workflow never defined', intro: 'An agent cannot rescue a process that nobody understands. Start with the hand-offs, decisions and exceptions that define the work.',
  ...
  {
    slug: 'measure-automation-value', image: '/images/news-marketing.svg', date: '30 May 2026', read: '19 min read', tag: 'Management', title: 'Hours saved are not cash, and the gap between them can be measured', intro: 'A credible case links operational baselines, adoption and quality. It does not multiply theoretical minutes by salary and call the result cash.',
