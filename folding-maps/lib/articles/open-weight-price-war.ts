...
const gartnerAgentic = { label: 'Gartner, forecast on agentic AI project cancellations, June 2025', href: 'https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027' };
const selfHostBreakEven = { label: 'SitePoint, local models against cloud APIs: cost of ownership, 2026', href: 'https://www.sitepoint.com/local-llms-vs-cloud-api-cost-analysis-2026/' };
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        { text: 'That reason cannot be the invoice alone. Self-hosting removes a usage fee and adds licensing, provenance, patching, capacity planning, security monitoring and service continuity, all of which land on the buyer or its infrastructure partner. It also exposes utilisation. Published break-even analyses make the point plainly: an accelerator held for bursty traffic sits idle most of the time, and an idle accelerator is an expensive way to serve a token. NIST treats generative AI risk as a lifecycle matter for a related reason, since a release that passed on the day it shipped degrades as models, data and usage patterns change. A data boundary, a latency requirement or a resilience obligation is a good reason to run a model locally. Avoiding a metered fee, on its own, will not survive the first quarter of operating one.', sources: [nistGenAi, selfHostBreakEven] },
      ],
      exhibits: [
