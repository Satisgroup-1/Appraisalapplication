...
| ROI denominator | Report **both** committed and drawn capital, in every profit mode. Done, AUDIT.md §6.8 (A5): `investorRoiOnCommitted` / `investorRoiOnDrawn` and their pa pair, plus the four capital bases, in both `simple` and `waterfall`. |
